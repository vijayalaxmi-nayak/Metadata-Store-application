module Api
  module V1
    class AccountsController < ApplicationController
      ...
      api :GET, '/show_media/:id', "Displays medias(audios or videos) of specific account based on id"
      param :id, :number, :desc => "Id"
      example %(
      ...
      api :GET, '/show_media_by_code/:id', "Displays medias(audios or videos) of specific account based on code"
